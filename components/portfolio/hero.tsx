...
// Dynamically import the entire 3D scene component to avoid SSR issues
const AvatarSceneWrapper = dynamic(
  () => import("./avatar-scene").then((mod) => mod.AvatarScene),
  { ssr: false, loading: () => <div className="w-full h-full flex items-center justify-center"><div className="animate-pulse text-muted-foreground">Loading 3D...</div></div> }
);
          ...
          >
            ...
            >
              ...
              <div className="relative z-10 w-full h-full">
                {isClient && <AvatarSceneWrapper mousePosition={mousePosition} />}
              </div>
            </div>
          </motion.div>
        </div>
